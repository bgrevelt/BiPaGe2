...
class DynamicCollectionExpressionSub(unittest.TestCase, IntegrationTest):
...
#include "dynamic_collection_expression_sub_integrationtest_generated.h"
#include <iostream>
#include <vector>
#include <limits>
#include "../check.hpp"
...
{            
    ...
    std::vector<std::uint8_t> collection1_values { 1,2,3,4,5 };
    std::vector<std::uint8_t> collection2_values { 11,12,13 };
